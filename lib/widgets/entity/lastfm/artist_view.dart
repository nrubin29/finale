      ...
      builder: (artist) => Scaffold(
        ...
        body: TwoUp(
          ...
          listItems: [
            Scoreboard(
              items: [
                .value(label: 'Scrobbles', value: artist.stats.playCount),
                .value(label: 'Listeners', value: artist.stats.listeners),
                .value(
                ...
                if (friendUsername != null)
                  .future(
                    ...
                    futureProvider: () => Lastfm.getArtist(
                      artist,
